...
"""
    1.  get_challenge:
        ...
        *   The challenge is generated as a UUID (Universally Unique Identifier), and it is stored in Redis 
            alongside the hashed combination of the stored password, the generated challenge, and the code hash retrieved from Vault.
    ...
    3.  _get_vault_token:
        ...
        *   This function retrieves the Vault root token from Redis, which is used for authentication when making requests to Vault for retrieving secrets.
    
    4.  _get_stored_password:
