...
def predict(cfg):
    init_tracker()
    ##print("URL %s", parse.unquote(cfg.source))
    cfg.model = cfg.model or "yolov8n.pt"
    cfg.imgsz = check_imgsz(cfg.imgsz, min_dim=2)  # check image size
    ##cfg.source = parse.unquote(cfg.source) if cfg.source is not None else ROOT / "assets"
    cfg.source = "https://49-d2.divas.cloud/CHAN-8293/CHAN-8293_1.stream/playlist.m3u8?83.52.13.30&vdswztokenhash=cy0V54p4eY_4209Ljv9UVJqWIa_dIQo24HrIkL8A3qg="
